...
public class Sun {
	...
	private static final float WINDOW_DIMENSION_DIVIDE_BY = 13;
	 ...
	 * @param groundLevel      The vertical position representing the groun level;
	 *                           used as the center of the sun's circular path.
	...
	public static GameObject create(Vector2 windowDimensions, float cycleLength, float groundLevel) {
		...
		Vector2 sunSize =
				new Vector2(windowDimensions.x() / WINDOW_DIMENSION_DIVIDE_BY,
